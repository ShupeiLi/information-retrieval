...
# Configuration ========================================================================================================
logging.basicConfig(level=logging.INFO, filename="task3.log", format="%(asctime)s %(message)s", filemode="a")
...
map_run = {"mini_run": mini_run, "tiny_run": tiny_run, "bert_run": bert_run}
for comb in combinations(["mini_run", "tiny_run", "bert_run"], 2):
    log_results("+".join(comb))
    comb_lst = list()
    for one_run in comb:
        comb_lst.append(map_run[one_run])
